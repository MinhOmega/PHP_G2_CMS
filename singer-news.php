...
$tin = tintuc::getTinTucTheoId($_REQUEST["id"]);
?>
            ...
            <div class="col-md-8">
                ...
                <article class="article article-post">
                    ...
                    <div class="article-main-img">
                        <img src="./img/<?php echo $tin->anh?>" alt="">
                    </div>
                    <div class="article-body">
                        ...
                        <h1 class="article-title"><?php echo $tin->tieude?></h1>
                        <ul class="article-meta">
                            <li><i class="fa fa-clock-o"></i> <?php echo $tin->ngay?></li>
                            <li><i class="fa fa-comments"></i> <?php echo $tin->tacgia?></li>
                        </ul>
