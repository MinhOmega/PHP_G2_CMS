...
<?php 
    ...
    if(isset($_REQUEST['addNew'])){
        ...
        tintuc::ThemTinTuc($tieude,$noidung,$anh,$tacgia,$ngayTao,$theloai);
        $check = "Thêm Tin Tức Thành Công!";
    }
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="" enctype='multipart/form-data' method="POST">
                            ...
                            <button type="submit" name="addNew" class="btn btn-default">Thêm tin tức</button>
