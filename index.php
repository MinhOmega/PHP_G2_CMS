<?php include_once("header-news.php");
?>
<?php
include_once("model/tintuc.php");
include_once("model/theloai.php");
$lsTinTuc = tintuc::getTinTuc();
$lsPopular = tintuc::getTinTucPopular();
$lsPopular2 = tintuc::getTinTucPopular2();
$keyWord = null;
if (isset($_REQUEST["search"])) {
	$keyWord = $_REQUEST['search'];
	$lsTinTuc = tintuc::getListSearch($keyWord);
}
?>
<!-- SECTION -->
<div class="section">
			...
			<div class="col-md-12">
				...
				<div class="tab-content">
					...
					<div id="tab1" class="tab-pane fade in active">
						...
						<div class="row">
							<?php foreach ($lsPopular as $key => $value) { ?>
								<!-- Column 1 -->
								<div class="col-md-3 col-sm-6">
									<!-- ARTICLE -->
									<article class="article">
										<div class="article-img">
											<a href="singer-news.php?id=<?php echo $value->id ?>">
												<img style="width: 262.5px; height: 196.8px;" src="./img/<?php echo $value->anh ?>" alt="">
											</a>
										...
										<div class="article-body">
											<h4 class="article-title"><a href="singer-news.php?id=<?php echo $value->id ?>"><?php echo $value->tieude ?></a></h4>
											<ul class="article-meta">
												<li><i class="fa fa-clock-o"></i><?php echo $value->ngay ?></li>
												<li><i class="fa fa-comments"></i> <?php echo $value->tacgia ?></li>
											</ul>
										</div>
									</article>
									<!-- /ARTICLE -->
						...
						<div class="row">
							<!-- Column 1 -->
							<?php foreach ($lsPopular2 as $key => $value) { ?>
								<div class="col-md-4 col-sm-6">
									<!-- ARTICLE -->
									<article class="article widget-article">
										<div class="article-img">
											<a href="singer-news.php?id=<?php echo $value->id ?>">
												<img style="width: 80px; height: 80px;" src="./img/<?php echo $value->anh ?>" alt="">
											</a>
										</div>
										<div class="article-body">
											<h4 class="article-title"><a href="singer-news.php?id=<?php echo $value->id ?>"><?php echo $value->tieude ?></a></h4>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<?php foreach ($lsTinTuc as $key => $value) { ?>
					<!-- ARTICLE -->
					<article class="article row-article">
						<div class="article-img">
							<a href="singer-news.php?id=<?php echo $value->id ?>">
								<img src="./img/<?php echo $value->anh ?>" alt="">
							</a>
						</div>
						<div class="article-body">
							<ul class="article-info">
							...
							<h3 class="article-title"><a href="singer-news.php?id=<?php echo $value->id ?>"><?php echo $value->tieude ?></a></h3>
							<ul class="article-meta">
								<li><i class="fa fa-comments"></i><?php echo $value->tacgia ?></li>
								<li><i class="fa fa-clock-o"></i><?php echo $value->ngay ?></li>
							</ul>
...
<!-- /SECTION -->
<?php include_once("footer-news.php");
?>